module money_market::ipx_money_market_core {
  ...
  #[test_only]
  friend money_market::ipx_money_market_test_2;
  ...
  const FLASH_LOAN_FEE: u256 = 5000000000000000; // 0.005%
  ...
  fun init(witness: IPX_MONEY_MARKET_CORE, ctx: &mut TxContext) {
    transfer::transfer(
      MoneyMarketAdminCap {
        id: object::new(ctx)
      },
    ...
    transfer::share_object(
      MoneyMarketStorage {
        ...
        publisher: package::claim<IPX_MONEY_MARKET_CORE>(witness, ctx),
        lock: false
      }
    );
  }
  ...
  * @param sender The account, which the asset will be assigned to
  */
  public(friend) fun enter_market<T>(money_market_storage: &mut MoneyMarketStorage, sender: address) {
  ...
  * @param sender The account, which the asset will be assigned to
  */
  public(friend) fun exit_market<T>(
    money_market_storage: &mut MoneyMarketStorage, 
    interest_rate_model_storage: &InterestRateModelStorage,
    price_potatoes: vector<PricePotato>,
    clock_object: &Clock,
  ...
  */
  public(friend) fun get_rewards<T>(
    money_market_storage: &mut MoneyMarketStorage, 
    interest_rate_model_storage: &InterestRateModelStorage,
  ...
  * @return Coin<IPX> It will mint IPX rewards to the user.
  */
  public(friend) fun get_all_rewards(
    money_market_storage: &mut MoneyMarketStorage, 
    interest_rate_model_storage: &InterestRateModelStorage,
    ipx_storage: &mut IPXStorage, 
    clock_object: &Clock,
  ...
  */
  ...
  public fun flash_loan<T>(
    ...
    ctx: &mut TxContext
      ...
      money_market_storage.lock = true;
  ...
  * @param borrower The address of the borrower that will be liquidated
  * @param liquidator_address The address of the liquidator
  * Requirements: 
  ...
  */
  ...
  public fun init_for_testing(ctx: &mut TxContext) {
    init(IPX_MONEY_MARKET_CORE {}, ctx);
  }
