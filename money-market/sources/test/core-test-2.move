...
module money_market::ipx_money_market_test_2 {
  ...
  #[test]
  #[expected_failure(abort_code = money_market::ipx_money_market_core::ERROR_LIQUIDATOR_IS_BORROWER)]
  ...
  #[test]
  #[expected_failure(abort_code = money_market::ipx_money_market_core::ERROR_ACCOUNT_COLLATERAL_DOES_EXIST)]
  ...
  #[test]
  #[expected_failure(abort_code = money_market::ipx_money_market_core::ERROR_ACCOUNT_LOAN_DOES_EXIST)]
...
#[test]
  #[expected_failure(abort_code = money_market::ipx_money_market_core::ERROR_ZERO_LIQUIDATION_AMOUNT)]
